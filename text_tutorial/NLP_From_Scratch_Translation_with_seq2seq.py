...
def readLangs(lang1, lang2, reverse=False):
    ...
    lines = open(base_dir + '/text_tutorial/data/%s-%s.txt' % (lang1, lang2), encoding='utf-8').\
        read().strip().split('\n')
...
class EncoderRNN(nn.Module):
    def __init__(self, input_size, hidden_size):
        ...
        self.embedding = nn.Embedding(input_size, hidden_size)      # input_size即N，hidden_size即将单词变成多少维度的向量
